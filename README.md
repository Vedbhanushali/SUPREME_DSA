...
[difference of endl and \n](./2_basic_of_programmin_II/README.md)  
[C datatypes](./2_basic_of_programmin_II/README.md)  
[ascii table](./2_basic_of_programmin_II/README.md)  
[negative number storeing](./2_basic_of_programmin_II/README.md)  
[Switch](./2_basic_of_programmin_II/README.md)  
[Miscellaneous](./2_basic_of_programmin_II/README.md)  
[Time comlexity precedence](./2_basic_of_programmin_II/README.md)

## 2. Arrays

[Sort zero's & one's (Dutch national flag problem)](/3_Array/README.md)  
...
[find duplicate Number](/3_Array/Assignment.md)  
[missing elements from an array with duplicate](/3_Array/Assignment.md)  
[Find first occurence](/3_Array/Assignment.md)  
[Common element in 3 sorted array](/3_Array/Assignment.md)  
[Wave print a matrix](/3_Array/Assignment.md)  
[Spiral print a matrix](/3_Array/Assignment.md)  
[add two number of array](/3_Array/Assignment.md)  
[find factorial of number](/3_Array/Assignment.md)

## 3. Binary Search

[binary search](/4_searching_and_sorting/binary_search.md)  
[find first occurrence](/4_searching_and_sorting/binary_search.md)  
[find last occurrence](/4_searching_and_sorting/binary_search.md)  
[total number of occurrences](/4_searching_and_sorting/binary_search.md)  
[find peak element in mountain array](/4_searching_and_sorting/binary_search.md)  
[find pivot element in array](/4_searching_and_sorting/binary_search.md)  
[search in sorted rotated array](/4_searching_and_sorting/binary_search.md)  
[find square root](/4_searching_and_sorting/binary_search.md)  
[search in nearly sorted array](/4_searching_and_sorting/binary_search.md)  
[Divide two numbers using binary search](/4_searching_and_sorting/binary_search.md)
[Binary search in 2D matrix](/4_searching_and_sorting/binary_search.md)

### index based binary search

[find missing elements (index based binary search)](/4_searching_and_sorting/binary_search.md)  
[find odd occuring element in an array](/4_searching_and_sorting/binary_search.md)

## 3. Sorting

[Selection sort](/4_searching_and_sorting/sorting.md)  
[Bubble sort](/4_searching_and_sorting/sorting.md)  
...
[Exponential Search & Unbounded](/4_searching_and_sorting/Assignment.md)  
[Binary Search](/4_searching_and_sorting/Assignment.md)  
[Book Allocation Problem](/4_searching_and_sorting/Assignment.md)  
[Painters Partition Problem](/4_searching_and_sorting/Assignment.md)  
[Aggresive Cows](/4_searching_and_sorting/Assignment.md)  
[EKO SPOJ](/4_searching_and_sorting/Assignment.md)  
[PRATA](/4_searching_and_sorting/Assignment.md)

## 4. Char arrays and string

[input string methods](./5_char_array_string/README.md)  
[check palindrome](./5_char_array_string/README.md)  
[remove duplicates](./5_char_array_string/README.md)  
[remove all occurrences of part from main string](./5_char_array_string/README.md)  
[valid palindrome 2](./5_char_array_string/README.md)  
...
[longest common prefix](./5_char_array_string/Assignment.md)  
[reverse vowels of as string](./5_char_array_string/Assignment.md)  
[isomorphic string](./5_char_array_string/Assignment.md)  
[reorganize string](./5_char_array_string/Assignment.md)  
[group anagram](./5_char_array_string/Assignment.md)  
[longest palindromix substring](./5_char_array_string/Assignment.md)  
[find the index of first occurence in a string](./5_char_array_string/Assignment.md)  
[string to integer (stoi)](./5_char_array_string/Assignment.md)  
[string compression](./5_char_array_string/Assignment.md)  
[Integers to Roman](./5_char_array_string/Assignment.md)  
[Zigzag conversion](./5_char_array_string/Assignment.md)  
[Largest number](./5_char_array_string/Assignment.md)

## Pointers and Mathematics algorithms

[Seive of Erathosthenes - prime number](/6_pointers_maths/README.md)  
[GCD euclid algorithm](/6_pointers_maths/README.md)  
[Modulus properties](/6_pointers_maths/README.md)  
[Fast exponential pow(a,b)](/6_pointers_maths/README.md)  
[Pigeon hole](/6_pointers_maths/README.md)  
